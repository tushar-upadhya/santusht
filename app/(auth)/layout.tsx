...
const Layout = ({ children }: { children: React.ReactNode }) => {
    return (
        <div className="flex min-h-screen bg-white dark:bg-accent">
            <section className="hidden w-1/2 items-center justify-center bg-brand p-10 lg:flex xl:w-2/5">
                <div className="flex max-h-[800px] max-w-[430px] flex-col justify-center space-y-12">
                    ...
                    <div className="space-y-5 dark:text-gray-300">
                        ...
                        <p className="text-[16px] leading-[24px] font-normal capitalize">
            ...
            <section className="flex flex-1 flex-col items-center bg-white dark:bg-accent p-4 py-10 lg:justify-center lg:p-10 lg:py-0">
